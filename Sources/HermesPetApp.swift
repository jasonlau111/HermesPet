...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private static func statusBarIcon(accessibilityDescription: String) -> NSImage {
        guard let image = statusBarIconImage() else {
            let fallback = NSImage(systemSymbolName: "questionmark.circle", accessibilityDescription: accessibilityDescription)
    ...
    private static func statusBarIconImage() -> NSImage? {
        let name = "StatusBarLogoTemplate"
